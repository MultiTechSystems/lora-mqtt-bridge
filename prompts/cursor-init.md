# Cursor Agent Initialization for MultiTech Gateway Development

This document provides prompts and information to initialize a Cursor Agent session for developing and deploying custom Python applications to MultiTech Conduit gateways.
...
sshpass -p 'yourpassword' ssh admin@192.168.1.100 \
  "grep lora-mqtt-bridge /var/log/messages | tail -50"
```
