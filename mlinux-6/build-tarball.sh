...
# Build script for LoRa MQTT Bridge mLinux 6.3.5 custom application tarball
...
VERSION="1.0.0"
TARBALL_NAME="lora_mqtt_bridge-${VERSION}-mlinux6.tar.gz"
BUILD_DIR="$SCRIPT_DIR/build"

echo "Building LoRa MQTT Bridge tarball for mLinux 6.3.5..."
