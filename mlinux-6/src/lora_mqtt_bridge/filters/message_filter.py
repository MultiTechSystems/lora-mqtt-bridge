...
class MessageFilter:
    ...
    def __init__(self, config: "MessageFilterConfig") -> None:
        ...
        """
        self.config = config
        self._deveui_whitelist = set(config.deveui_whitelist)  # type: Set[str]
        self._deveui_blacklist = set(config.deveui_blacklist)  # type: Set[str]
        self._joineui_whitelist = set(config.joineui_whitelist)  # type: Set[str]
        self._joineui_blacklist = set(config.joineui_blacklist)  # type: Set[str]
