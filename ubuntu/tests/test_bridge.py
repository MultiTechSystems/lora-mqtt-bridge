...
class TestMQTTBridge:
    ...
    def test_parse_message_type_moved(self, bridge_config: BridgeConfig) -> None:
        """Test parsing moved message type from topic.
        ...
        assert bridge._parse_message_type("lora/eui/device/moved") == MessageType.MOVED

    def test_parse_message_type_clear(self, bridge_config: BridgeConfig) -> None:
        """Test parsing clear message type from topic.
        ...
        assert bridge._parse_message_type("lora/device/clear") == MessageType.CLEAR
